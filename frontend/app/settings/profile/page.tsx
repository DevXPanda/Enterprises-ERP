          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3.5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[13px] text-white/90 mb-1.5 font-medium">
                    Full Name
                    <span className="text-danger ml-0.5 font-medium" aria-hidden="true">*</span>
                  </label>
                  <input
                    type="text"
                    value={adminName}
                    onChange={(e) => setAdminName(e.target.value)}
                    className="w-full h-[48px] px-4 bg-navy/60 border border-border/40 rounded-xl text-sm text-white placeholder:text-muted/40 outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
                    required
                  />
                </div>
                <div>
                  <label className="block text-[13px] text-white/90 mb-1.5 font-medium">System Role</label>
                  <input
                    type="text"
                    value="Super Admin"
                    disabled
                    className="w-full h-[48px] px-4 bg-navy-300/20 border border-border/30 rounded-xl text-sm text-muted cursor-not-allowed outline-none"
                  />
                </div>
              </div>
        ...
        <div className="bg-card/60 border border-border/30 rounded-2xl p-5 space-y-5 flex flex-col justify-between">
          <div className="space-y-5">
            ...
            <div className="space-y-3.5 pt-2">
              <div>
                <label className="block text-[13px] text-white/90 mb-1.5 font-medium">Current Password</label>
                <input
                  type="password"
                  value={currentPassword}
                  onChange={(e) => setCurrentPassword(e.target.value)}
                  placeholder="Enter current password"
                  className="w-full h-[48px] px-4 bg-navy/60 border border-border/40 rounded-xl text-sm text-white placeholder:text-muted/30 outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
                />
              </div>

              <div>
                <label className="block text-[13px] text-white/90 mb-1.5 font-medium">New Password</label>
                <div className="relative">
                  <input
                    ...
                    className="w-full h-[48px] pl-4 pr-10 bg-navy/60 border border-border/40 rounded-xl text-sm text-white placeholder:text-muted/30 outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
                  />
                  <button
                    type="button"
              ...
              <div>
                <label className="block text-[13px] text-white/90 mb-1.5 font-medium">Confirm New Password</label>
                <input
                  type="password"
